            ...
            <div className="container mx-auto px-6 py-12 md:py-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed">
                        We specialize in the design, fabrication, and installation of high-quality steel solutions tailored to your needs. With precision craftsmanship and a commitment to durability, we deliver exceptional results across residential, commercial, and industrial projects.
                    </p>
                </div>
            </div>
        </article>
